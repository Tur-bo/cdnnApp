...
<img src="../../../statics/images/icon_photo.png" />
<br>
...
<a class="list-link" @click='previewImage(iu,$event)'>
<img :src="iu">
</a>
...
previewImage: function (url,e) {
  ...
  ImagePreview(this.imgUrls);
  EXIF.getData(vm.files, function(){
...
.list-img-close {
  background: #ffffff url('../../../statics/images/del.png') no-repeat right top;
  border-color: #ff4a00;
...
.add-img {
  display: block;
  background-image: url('../../../statics/images/addimg.png');
